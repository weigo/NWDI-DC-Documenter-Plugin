...
public class DomHelper {
     ...
     */
    protected final Element createElement(final String elementName) {
        return document.createElement(elementName);
    }

    /**
     * Erzeugt ein DOM-Element mit dem �bergebenen Namen und Attributnamen und
     * -werten. Die L�nge der beiden �bergebenen Felder muss �bereinstimmen.
     *
     * @param elementName
     *            Elementname
     ...
     */
    protected final Element createElement(final String elementName, final String[] attributeNames,
     ...
     *            zum Attributnamen geh�riger Attributwert f�r das zu erzeugende
     *            Element
     * @return erzeugtes Element mit �bergebenem Namen und Attribut
     */
    protected final Element createElement(final String elementName, final String attributeName,
     ...
     */
    protected final Element createText(final String elementName, final String text) {
        final Element element = this.createElement(elementName);
